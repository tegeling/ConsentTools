...
sfdx force:package:version:promote --package "Consent Tools@1.1.0-1" --targetdevhubusername devhubWinter22

https://login.salesforce.com/packaging/installPackage.apexp?p0=04t7Q000000DdrIQAS
https://test.salesforce.com/packaging/installPackage.apexp?p0=04t7Q000000DdrIQAS
